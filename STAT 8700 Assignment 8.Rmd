...
# 3. The table at the end of the assignment gives the number of fatal accidents and deaths on scheduled airline flights per year over a ten year period from 1976 to 1985.
...
# 4. Repeat 3 above, replacing 'fatal accidents' with 'passenger deaths.'
